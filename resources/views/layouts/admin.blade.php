...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="admin_assets/media/favicons/favicon.png">
    <link rel="icon" type="image/png" sizes="192x192" href="admin_assets/media/favicons/favicon-192x192.png">
    <link rel="apple-touch-icon" sizes="180x180" href="admin_assets/media/favicons/apple-touch-icon-180x180.png">
    <!-- END Icons -->
    ...
    <link rel="stylesheet" id="css-main" href="admin_assets/css/codebase.min.css">
    <script src="https://code.jquery.com/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>

    <!-- You can include a specific file from css/themes/ folder to alter the default color theme of the template. eg: -->
    <!-- <link rel="stylesheet" id="css-theme" href="admin_assets/css/themes/flat.min.css"> -->
    <!-- END Stylesheets -->
  </head>
  <body>
    <!-- Page Container -->
      ...
      <aside id="side-overlay">
        ...
        <div class="content-header">
          ...
          <a class="img-link me-2" href="be_pages_generic_profile.html">
            <img class="img-avatar img-avatar32" src="admin_assets/media/avatars/avatar15.jpg" alt="">
          </a>
          <!-- END User Avatar -->
              ...
              <ul class="nav-users">
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="admin_assets/media/avatars/avatar7.jpg" alt="">
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="admin_assets/media/avatars/avatar11.jpg" alt="">
                    <i class="fa fa-circle text-success"></i>
                    <div>Carl Wells</div>
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="admin_assets/media/avatars/avatar10.jpg" alt="">
                    <div>Ryan Flores</div>
            ...
            <div class="content-side content-side-user px-0 py-0">
              ...
              <div class="smini-hidden text-center mx-auto">
                <a class="img-link" href="be_pages_generic_profile.html">
                  <img class="img-avatar" src="admin_assets/media/avatars/avatar15.jpg" alt="">
                </a>
              ...
              <div class="dropdown-menu dropdown-menu-lg p-0" aria-labelledby="page-header-themes-dropdown">
                ...
                <div class="p-3">
                  <div class="row g-0 text-center">
                    ...
                    <div class="col-2">
                      <a class="text-elegance" data-toggle="theme" data-theme="admin_assets/css/themes/elegance.min.css" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-pulse" data-toggle="theme" data-theme="admin_assets/css/themes/pulse.min.css" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-flat" data-toggle="theme" data-theme="admin_assets/css/themes/flat.min.css" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-corporate" data-toggle="theme" data-theme="admin_assets/css/themes/corporate.min.css" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-earth" data-toggle="theme" data-theme="admin_assets/css/themes/earth.min.css" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                  </div>
    ...
    <!--
        ...
        webpack is putting everything together at admin_assets/_js/main/app.js
    -->
    <script src="admin_assets/js/codebase.app.min.js"></script>

    <!-- Page JS Plugins -->
    <script src="admin_assets/js/plugins/chart.js/chart.min.js"></script>
