<!-- Pop In Modal -->
<div class="modal fade" id="modal-popin-edit{{$org->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-popin"
  aria-hidden="true">
                ...
                <div class="col-lg-8 col-xl-12">
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control" name="legal_name"
                      placeholder="Legal Name" value="{{$org->legal_name}}">
                    <label class="form-label">Legal Name</label>
                  </div>
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control" name="description"
                      placeholder="Description" value="{{$org->description}}">
                    <label class="form-label">Description</label>
                  </div>
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control" name="source"
                      placeholder="Source" value="{{$org->source}}">
                    <label class="form-label">Source</label>
                  </div>
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control" name="inn"
                      placeholder="Inn" value="{{$org->inn}}">
                    <label class="form-label">Inn</label>
                  </div>
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control" name="location"
                      placeholder="Location" value="{{$org->location}}">
                    <label class="form-label">Location</label>
                  </div>
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control" name="head_person_name"
                      placeholder="Head Person Name" value="{{$org->head_person_name}}">
