...
<script>
  ...
  $('.reply').click(function () {
    ...
    $('#comment_reply_username').html($('#comment_username_' + organisation_id).html())
          ...
          <div class="user-card shadow border bg-white p-4 text-center">
            <div class="user-info">
              <div class="user-details">
                ...
                <img src="{{ asset('storage/'.$organisation->logo) }}" alt="organisation logo" class="rounded">
                @endif
          ...
          <div class="sidebar-pdt-desc mt-4">
            <div class="shadow border p-4 text-center">
              ...
              <div class="d-inline-block mx-2 mb-2">
                @include('organisations.components.tag', ['name' => $category->name])
              </div>
              @endforeach
            </div>
          </div>
        ...
        <div class="card shadow mx-0 mb-lg-0">
          ...
          <div class="card-image">
            ...
            <div class="image-overlay">
              <a href="single-product.html" class="btn btn-outline-white radius-5 py-3 px-4  text-capitalize">More
                Info</a>
            </div>
          </div>
